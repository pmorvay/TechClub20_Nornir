...
#Parse output - Genie
#Get specific value in Execute part
...
result = onlyXE.run(task=get_commands, commands=["show version", "show ip interface brief"])
print(f"==== {result['sandXE.cisco'][1].result['version']['version']} ====\n")
